    ...
    while (1) {
        ...
        switch (input_answer) {
            ...
            case 6:{
                ...
                strcpy(setup.header_json, "{\"X-Auth-Token\":\"bb95c0693ce9bd1398afb46e1ed19566\"}");
...
void http_request_respone_callback(const ks_http_request_result* result, void* arg){
    ...
    if(result->response->response_data){
        ...
        if(!strcmp(result->request->uri, "/image/jpeg")){
            ...
            pFile = fopen("//Users//Shih//Desktop//ks_http_request_performer//sample//123.jpeg","wb");
            ...
            pFile = fopen("//Users//Shih//Desktop//ks_http_request_performer//sample//123.png","wb");
